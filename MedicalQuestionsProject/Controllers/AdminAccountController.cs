...
namespace MedicalQuestionsProject.Controllers
{
    public class AdminAccountController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserID,Email,PasswordHash,Name,Mobile,IsAdmin")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserID,Email,PasswordHash,Name,Mobile,IsAdmin")] User user)
        {
            if (ModelState.IsValid)
            {
